            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="បំពេញឈ្មោះក្រុមហ៊ុន">
                        @error('name')
                ...
                <button type="submit" class="btn btn-primary ml-3">Save Company</button>
            </div>
        </form>
    </div>
</body>
